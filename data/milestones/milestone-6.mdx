...
summary: 'This milestone consists of a proper market research, including also the main competitors.'
chapters: [
    'Target market',
    'Competitors',
...
- Promoting ads
- Post more than 3 ads (the first 3 are free)
- Obtaining a percentage of the cost of a published service. 

For Agromag, the main sources will come from the promotion of ads, the publication of more than 3 ads, but also the percentage obtained from the value of the service. We estimate to have a profit of **500 RON per month**, accumulating **6000 RON in the first year** obtained from the promotion of the ads; another gain from the publication of a number of more than 3 ads worth **460 RON per month**, accumulating **5520 RON in the first year** and a gain of **500 RON per month **obtained from the percentage of services, reaching **6000 RON**.
