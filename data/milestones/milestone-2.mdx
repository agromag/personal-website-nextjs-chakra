...
summary: 'This milestone is focusing on testing the problem, and then the solution, going through the customer discovery process.'
chapters: [
    'Finding the problem',
    'Building a solution',
    'Customer discovery',
...
### After analyzing the results obtained by spreading this form, we drew the following conclusions:
...
<FaqComponent title="Interview 1">
...
<FaqComponent title="Interview 2">
